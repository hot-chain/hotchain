...
#include <hotc_hotc/net_plugin/net_plugin.hpp>
#include <hotc_hotc/net_plugin/protocol.hpp>
#include <hotc_hotc/chain/chain_controller.hpp>
#include <hotc_hotc/chain/exceptions.hpp>
...
namespace hotc_hotc {
  ...
  using hotc_hotc::chain::transaction_id_type;
  ...
  void net_plugin::set_program_options( options_description& cli, options_description& cfg )
  {
    cfg.add_options()
      ...
      ("agent-name", bpo::value<string>()->default_value("HOTC_HOTC Test Agent"), "The name supplied to identify this node amongst the peers.")
      ;
  }
