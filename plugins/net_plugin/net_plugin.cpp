...
#include <hotc/net_plugin/protocol.hpp>
...
#warning ("TODO: reconstruct actual block from cached transactions")
  ...
  void net_plugin::set_program_options( options_description& cli, options_description& cfg )
  {
    cfg.add_options()
      ...
      ("agent-name", bpo::value<string>()->default_value("HOTC Test Agent"), "The name supplied to identify this node amongst the peers.")
      ;
  }
