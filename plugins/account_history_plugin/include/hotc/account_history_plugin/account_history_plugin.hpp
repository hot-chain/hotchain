...
FC_REFLECT(hotc::account_history_apis::empty, )
FC_REFLECT(hotc::account_history_apis::read_only::get_transaction_params, (transaction_id) )
FC_REFLECT(hotc::account_history_apis::read_only::get_transaction_results, (transaction) )
