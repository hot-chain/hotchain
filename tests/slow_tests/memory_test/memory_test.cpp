...
#include <hotclib/message.h>
//#include <hotclib/types.hpp>
#include <hotclib/memory.hpp>
...
extern "C" {
    ...
    void test_memory()
    {
       ...
       ptr1[14] = 0x7e;
       ptr1[29] = 0x7f;
       ptr1_realloc = (char*)hotc::realloc(ptr1, 15);
       assert(ptr1_realloc != nullptr, "should have returned a buffer");
       ...
       ptr1_realloc = (char*)hotc::realloc(ptr1, 30);
       assert(ptr1_realloc != nullptr, "should have returned a buffer");
       ...
       ptr1[29] = 0x7f;
       ptr1_realloc = (char*)hotc::realloc(ptr1, 31);
       assert(ptr1_realloc != nullptr, "should have returned a buffer");
       ...
       char* nullptr_realloc = (char*)hotc::realloc(nullptr, 50);
       ...
       char* invalid_ptr_realloc = (char*)hotc::realloc(nullptr_realloc + 4, 10);
       ...
       ptr1 = ptr1_realloc;
       ptr1_realloc = (char*)hotc::realloc(ptr1, 8028);
       assert(ptr1_realloc == nullptr, "should have returned a nullptr");

       // re-allocate to max
       ptr1_realloc = (char*)hotc::realloc(invalid_ptr_realloc, 8027);
       assert(ptr1_realloc != nullptr, "should have returned a buffer");
