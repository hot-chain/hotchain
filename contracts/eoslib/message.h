...
extern "C" {
    ...
    *
    *
    * A HOTC.IO message has the following abstract structure:
    *
    * ```
    *   struct Message {
    ...
    * print(Name(code)); // Output: hotc
    *
    * assert(Name(currentCode()) === "hotc", "This message expects to be received by hotc"); // Do nothing
