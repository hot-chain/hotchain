...
namespace hotc {
  ...
  *  @tparam CurrencyType - type of the currency (e.g. hotc) represented as an unsigned 64 bit integer
  *  @ingroup tokens
  *
  ...
  *  Example:
  *  @code
  *  typedef hotc::token<uint32_t, N(MyToken)> MyToken;
  *  MyToken  a(128);
  ...
  */
  ...
  struct token {
    /**
    * Type of the currency (e.g. hotc) represented as an unsigned 64 bit integer
    ...
    */
    ...
    /**
    * Print as string representation of the token (e.g. 1 HOTC)
  ...
  *  Example:
  *  @code
  *  typedef hotc::token<uint64_t, N(MyBaseToken)> MyBaseToken;
  *  typedef hotc::token<uint64_t, N(MyQuoteToken)> MyQuoteToken;
  ...
  */
  ...
  /**
  * @typedef Tokens
  * @brief Defines hotc tokens
  * @details Defines hotc tokens
  */
  typedef hotc::token<uint64_t,N(hotc)>   Tokens;

  /**
  *  @struct hotc::Transfer
