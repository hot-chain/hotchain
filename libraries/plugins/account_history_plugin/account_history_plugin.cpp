...
CHAINBASE_SET_INDEX_TYPE( hotc::transaction_history_object, hotc::transaction_history_multi_index )

FC_REFLECT( hotc::transaction_history_object, (block_id)(transaction_id) )
