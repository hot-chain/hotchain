...
#include <hotc/chain/multi_index_includes.hpp>
...
namespace config = ::hotc::config;
namespace chain = ::hotc::chain;
namespace types = ::hotc::types;
...
class ProducerVotesObject : public chainbase::object<chain::producer_votes_object_type, ProducerVotesObject> {
   ...
   struct {
      ...
      void update(types::ShareType currentSpeed, types::UInt128 currentPosition, types::UInt128 currentRaceTime) {
         ...
         HOTC_ASSERT(currentRaceTime <= std::numeric_limits<types::UInt128>::max() - projectedTimeToFinish,
...
} } // namespace native::hotc

CHAINBASE_SET_INDEX_TYPE(native::hotc::ProducerVotesObject, native::hotc::ProducerVotesMultiIndex)
CHAINBASE_SET_INDEX_TYPE(native::hotc::ProxyVoteObject, native::hotc::ProxyVoteMultiIndex)
CHAINBASE_SET_INDEX_TYPE(native::hotc::ProducerScheduleObject, native::hotc::ProducerScheduleMultiIndex)
