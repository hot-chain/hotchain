...
hotc::chain_apis::read_only::get_info_results get_info() {
...
void create_account( const vector<string>& cmd_line ) {
      ...
      trx.emplaceMessage(config::HotcContractName, vector<types::AccountPermission>{{creator,"active"}}, "newaccount",
