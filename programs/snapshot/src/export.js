...
const download_reclaimable = () => {
  ...
  let filename = `hotc-reclaimable_tx_${SNAPSHOT_ENV}_${SS_LAST_BLOCK}-${SS_FIRST_BLOCK}`
...
const download_reclaimed = () => {
  ...
  let filename = `hotc-successfully_reclaimed_tx_${SNAPSHOT_ENV}_${SS_LAST_BLOCK}-${SS_FIRST_BLOCK}`
...
const download_snapshot = () => {
  ...
  let filename = `hotc-snapshot_${SNAPSHOT_ENV}_${SS_LAST_BLOCK}-${SS_FIRST_BLOCK}`; 
...
const download_rejects = () => {
  ...
  let filename = `hotc-rejections_${SNAPSHOT_ENV}_${SS_LAST_BLOCK}-${SS_FIRST_BLOCK}`
...
const download_logs = () => {
  ...
  let filename = `hotc-logs_${SNAPSHOT_ENV}_${SS_LAST_BLOCK}-${SS_FIRST_BLOCK}`
