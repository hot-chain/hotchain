...
struct topology {
  ...
  void define_nodes (vector <hotc::hotcd_def> &nodes) {
  ...
  void make_ring (vector <hotc::hotcd_def> &nodes) {
    define_nodes (nodes);
    if (total_nodes > 2) {
  ...
  void make_star (vector <hotc::hotcd_def> &nodes) {
    define_nodes (nodes);
  ...
  void make_custom (vector <hotc::hotcd_def> &nodes) {
